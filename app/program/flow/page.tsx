    ...
    return (
        <main className="bg-white overflow-x-hidden">
            ...
            <section className="text-center mx-auto max-w-3xl">
                ...
                <Image src="/program/flow.jpg" alt="Flow Image" width={600} height={600} className="mx-auto mt-8 max-sm:max-w-[320px] max-w-[800px] object-contain"/>
            ...
            <div className="mx-auto max-sm:max-w-[250px] max-w-3xl text-center">
                <div className="border-t border-slate-500/70" />
                <h1 className="pt-10 text-blue-700 text-xl md:text-2xl font-bold">技能実習生の送り出し国</h1>
                <h2 className="pt-6 mx-auto text-xs md:text-xl text-gray-700">フィリピン、ベトナム、インドネシア<br />（2019年１月１日現在）</h2>
